  ...
  <div class="page addresses-page wrapper">
    <div class="addresses-page__content content">
      ...
      <div class="addresses-page__content__addresses">
          ...
          >
            ...
            >
              <InputBlock
                id="dadata"
                name="dadata"
                class="addresses-page__content__addresses__content__item__data__input-block addresses-page__content__addresses__content__item__data__input-block__dadata"
                text="Адрес доставки"
              />
              <div
                class="addresses-page__content__addresses__content__item__data__additional"
              >
                <InputBlock
                  id="intercom"
                  name="intercom"
                  class="addresses-page__content__addresses__content__item__data__additional__input-block addresses-page__content__addresses__content__item__data__additional__input-block__intercom"
                  text="№ домофона"
                />
                <InputBlock
                  id="entrance"
                  name="entrance"
                  class="addresses-page__content__addresses__content__item__data__additional__input-block addresses-page__content__addresses__content__item__data__additional__input-block__entrance"
                  text="Подъезд"
                />
                <InputBlock
                  id="floor"
                  name="floor"
                  class="addresses-page__content__addresses__content__item__data__additional__input-block addresses-page__content__addresses__content__item__data__additional__input-block__floor"
                  text="Этаж"
                />
                <InputBlock
                  id="apartment"
                  name="apartment"
                  class="addresses-page__content__addresses__content__item__data__additional__input-block addresses-page__content__addresses__content__item__data__additional__input-block__apartment"
                  text="№ квартиры/офиса"
                />
              </div>
              <ButtonStandart
        ...
        <ButtonStandart class="addresses-page__content__addresses__add">
          <svg
