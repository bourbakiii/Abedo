    ...
    <div class="addresses-page__content content">
      ...
      <div class="addresses-page__content__addresses">
        ...
        <div class="addresses-page__content__addresses__content">
          <AddressItem v-for='address,index in 1' :key='index'/>
        </div>
...
export default {
  ...
  methods: {
    ...
    dadata_request_new_addresses() {
      clearTimeout(this.suggestions.new_address_timer);
      this.suggestions.new_address_timer = setTimeout(() => {
        clearTimeout(this.suggestions.new_address_timer);
        this.$axios
          .post(
            "https://suggestions.dadata.ru/suggestions/api/4_1/rs/suggest/address",
            {
              query: this.new_address.value,
          ...
          .then(({ data: { suggestions } }) => {
            this.suggestions.new_address = suggestions;
          });
      }, 500);
    },
  },
