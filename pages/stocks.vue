...
export default {
  ...
  head() {
    return {
      title: `Акции заведений - Abedo`,
      meta:
        [
          {
            hid: 'description',
            name: 'description',
            content: 'На странице представлены акции заведений на маркетплейсе Abedo. Находите интересующие вас товары и услуги. Удобное оформление заказа через сайт или мобильное приложение.'
          }
        ],
    }
  },
