    ...
    <div class="catalog">
      <div class="catalog__top">
        ...
        <button
          ...
          class="catalog__top__filter-button"
        >
          <svg
            class="catalog__top__filter-button-icon adaptive-non"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
          ...
          <svg
            class="catalog__top__filter-button__icon adaptive"
            width="20"
            height="20"
            viewBox="0 0 20 20"
            fill="none"
      ...
      <div class="catalog__content">
        ...
        <ShopAdaptive
          v-for="(item, index) in 12"
          :key="index + 'adaptive'"
          class="catalog__content__item adaptive"
        />
      </div>
      <ButtonStandart
