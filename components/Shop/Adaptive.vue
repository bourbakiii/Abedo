<template>
  <NuxtLink to='/partners/1' class="shop-adaptive shop">
    ...
    <div class="shop-adaptive__info">
      ...
      <p class="shop-adaptive__info__category" contenteditable>Детская одежда</p>
    </div>
    <div class="shop-adaptive__icons">
      <span
        class="
          shop-adaptive__icons__icon__wrapper
          shop-adaptive__icons__icon__delivery
        "
      >
        <svg
          width="17"
      ...
      <span
        class="
          shop-adaptive__icons__icon__wrapper shop-adaptive__icons__icon__gift
        "
      >
        <svg
          width="17"
      ...
      <span
        class="
          shop-adaptive__icons__icon__wrapper
          shop-adaptive__icons__icon__discount
        "
      >
        <svg
          width="10"
